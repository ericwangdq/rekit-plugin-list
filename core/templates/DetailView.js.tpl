        ...
        <article className="fd-page">
          <header className="fd-page__header fd-has-background-color-background-2">
            ...
            <div className="fd-container fd-container--fluid" style={{ marginBottom: '15px' }}>
              <div className="fd-col--3">
                <FormSet>
                  <FormItem>
                    <FormLabel htmlFor="select-1">Code:</FormLabel>
                    <span className="form-text">CP100110</span>
                  </FormItem>
                  <FormItem>
          ...
          <div className="fd-page__content fd-has-background-color-neutral-2">
            <TabGroup>
                    ...
                    <div className="fd-col--4">
                      <FormSet>
                        <FormItem>
                          ...
                          <span className="form-text">CP100110 Buy S500525</span>
                        </FormItem>
                      </FormSet>
                    </div>
                  </div>
              ...
              <Tab id="3" title="Logistics">
                <section className="fd-section">
                  Lorem ipsum dolor sit amet consectetur adipisicing elit.
                </section>
              </Tab>
              <Tab id="4" title="Related Documents">
                <section className="fd-section">
                  Lorem ipsum dolor sit amet consectetur adipisicing elit.
                </section>
              </Tab>
              <Tab id="5" title="Accounting">
                <section className="fd-section">
                  Lorem ipsum dolor sit amet consectetur adipisicing elit.
                </section>
              </Tab>
